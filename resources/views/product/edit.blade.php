    ...
    <main class="container mt-5 bg-light">
        ...
        <form method="POST" action="{{ Route('product.update', $product->id) }}" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <input type="number" name="price" min="0.00" max="10000.00" step="0.01" class="form-control" value="{{ $product->price }}">
            </div>
            ...
            {{-- OPÇOES DE CATEGORIA
                ...
                4) O IF IRA DEIXAR SELECIONADO VERIFICANDO O ID DA CATEGORIA E USARA SELECTED
            --}}
            <div class="row">
